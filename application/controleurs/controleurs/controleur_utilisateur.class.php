    ...
    public function CreerCompte()
    {
        ...
        if (isset($_POST['creercompte'])){
            if (VariablesGlobales::$retour) {
                VariablesGlobales::$message = "<p>Le message c'est envoyé.</p>";
            }else{
            ...
            if (!empty($_POST)) {
                ...
                elseif (GestionUtilisateur::loginExistant($_POST['login'])) {
                    ...
                    VariablesGlobales::$bytes = bin2hex(random_bytes(5));
    ...
    public function mdpOublier(){
        ...
        if (isset($_POST['validermdp'])) {
            if (GestionUtilisateur::emailExistant($_POST['emails'])) {
                VariablesGlobales::$bytesmdp = bin2hex(random_bytes(5));
                ...
                VariablesGlobales::$message = "Le mail n'existe pas";
            }
        }
