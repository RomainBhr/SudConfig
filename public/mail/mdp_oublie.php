...
$message = '<div style="display: flex; margin: 0 auto; justify-content: center; text-align: center">
                <div style="background: #f1f1f1; width: 50%; text-align: center; padding: 110px 50px 140px 50px; box-shadow: black 5px 5px 7px 0px; margin-bottom: 25px; margin-top: 14px;">
                    ...
                    <h1 style="color: red">Nouveau mot de passe !</h1>
                    <hr style="width: 90%; margin: 5%">
                    <b>Votre nouveau mot de passe : </b>' . VariablesGlobales::$bytesmdp .'<br>
                    <b>Lien pour changer de mot de passe : </b>'. VariablesGlobales::$bytesmdp .'
                </div>
            </div>';

$retour = mail($_POST['emails'] , 'Changer de mot de passe sur SudConfig ! ', $message, VariablesGlobales::$entete);
