...
{
    public static $categoriedestouches;
    public static $prixCat;
    public static $prixDp;
    public static $prixCommande;
    public static $lecompteur;
    public static $messageredirection;
    public static $lesCategories;
    public static $lesProduits;
    public static $cat;
    public static $test;
    public static $LaCat;
    public static $lesImages;
    ...
    public static $commentaire;
    public static $leRestult;
    public static $message2;
    public static $touche;
    public static $bytes;
    public static $bytesmdp;
    public static $lurl;
    public static $mail;
